...
const Home = ({ dataset }) => {
  ...
  const {
    ...
    trendingDestinations_old: trendingDestinationsOld,
    trendingSpot,
    publicPresentation,
  } = dataset
            ...
            >
              ...
              <Box marginBottom="40px">
                <Typography variant="body1" className={classes.mobileTextCenter}>
                  ...
                  ExploMaker, c’est terminé ! Retrouve tout ce dont tu as besoin au sein d’une seule
                  et même interface.
                </Typography>
              </Box>
              <Button
                variant="contained"
                className={clsx(classes.buttonPrimary, classes.mediumSize, classes.v5MuiBUttonFix)}
              >
                Crée ton séjour
              </Button>
            </Box>
            ...
            >
              ...
              >
                ...
                <Box marginBottom="50px">
                  <Typography variant="body1" className={classes.mobileTextCenter}>
                    Ajoute hébergements, activités, restaurants, transports sur place et vols à ton
                    planning. Des envies différentes ? Chacun son planning ! Ajoute tes partenaires
                    de voyage uniquement aux événements qui les concernent.
                  </Typography>
                </Box>
              </Box>
              {matchesXs ? (
            ...
            <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center">
              ...
              <Box>
                {matchesXs ? (
                  ...
                  >
                    {currentPublicPresentation.map(({ logo: publicLogo, titre, texte, photo }) => (
                      <Box
                        display="flex"
                        flexDirection="column"
                        alignItems="center"
                      ...
                      >
                        <Image
                          src={
                            `https://storage.googleapis.com/stateless-www-explomaker-fr/${photo.src.orignal}` ??
                            travelPicture
                          }
                          width="1140"
                          quality={100}
                        ...
                        <Paper elevation={2} className={classes.travelTilePaper}>
                          <Box marginBottom="15px">
                            <Typography
                              variant="h5"
                              className={clsx({ [classes.rotate35Deg]: titre === 'Entre amis' })}
                            >
                              {publicLogo}
                            </Typography>
                          </Box>
                    ...
                    >
                      {travelBox.map(({ srcImg }) => (
                        <Box position="relative" key={srcImg}>
                          <Image src={travelPicture} width="1140" quality={100} />
                        </Box>
                      ))}
                    </Carousel>
      ...
      <Box className={classes.greyBackgroundContainer}>
        <Box className={classes.mainContainer} padding="60px 0">
          <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center">
            ...
            >
              <Box
                className={clsx(classes.mobileAlignCenter, classes.mobileMarginBottom)}
                width="50%"
              >
                <BlogCard
              ...
              <Paper elevation={2} className={clsx(classes.mobileSizing, classes.blogList)}>
                {hotArticles
                  ...
                  .map(({ title, meta }, index, currentArray) => (
                    <Box key={`hotArticles${title}`}>
                      ...
                      {index !== currentArray.length - 1 && <Divider className={classes.stroke} />}
                    </Box>
                  ))}
              </Paper>
            </Box>
            ...
            >
              <Link href="/inspiration">
                <Link href="/inspiration">Plus de lecture ?</Link>
              </Link>
            </Button>
          </Box>
        </Box>
              ...
              <Box className={classes.paperNewsletter}>
                ...
                <Box maxWidth="500px" marginBottom="20px">
                  ...
                  >
                    ...
                    <Box component="span" className={clsx(classes.fs34, classes.mobileSmallTitle)}>
                      🧭
                    </Box>
                  </Typography>
                </Box>
