...
const WPGAudioBlock = (props) => {
    ...
    React.useEffect(() => {
        var _a;
        if ((_a = attrs === null || attrs === void 0 ? void 0 : attrs.data) === null || _a === void 0 ? void 0 : _a.blog_log_list) {
    ...
    return (React.createElement("div", { className: "wpg-block wpg-b_audio" },
        React.createElement(core_1.Box, { sx: { position: 'relative', width: '660px', maxWidth: '660px' } },
            React.createElement(core_1.Box, { className: classes.carouselContainer },
                React.createElement(react_multi_carousel_1.default, { autoPlaySpeed: 3000, centerMode: false, draggable: true, arrows: false, focusOnSelect: false, infinite: false, renderButtonGroupOutside: !matchesXs, customButtonGroup: !matchesXs && React.createElement(CustomButtonGroup_1.default, null), 
                    // showDots={matchesXs}
                    // customDot={<TrendingDestinationsDotBox carouselArray={imgArray} />}
                    // dotListClass={dotListClass}
                    keyBoardControl: true, minimumTouchDrag: 80, partialVisible: matchesXs, responsive: {
                        desktop: {
                            breakpoint: {
                                max: 3000,
                                min: 640,
