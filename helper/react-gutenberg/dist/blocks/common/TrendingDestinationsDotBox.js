...
const TrendingDestinationsDotBox = _a => {
  var { carouselArray, isResults = false, onClick } = _a,
    rest = __rest(_a, ['carouselArray', 'isResults', 'onClick'])
  const { active } = rest
  ...
  return React.createElement(
    core_1.Box,
    { className: classes.trendingDotBox },
    React.createElement(
      core_1.Box,
      {
        component: core_1.ButtonBase,
        onClick: () => onClick(),
        height: '10px',
        mx: 1,
        borderRadius: '50px',
      ...
      React.createElement(core_1.Box, {
        className: (0, clsx_1.default)(classes.indicatorsCountryGallery, {
