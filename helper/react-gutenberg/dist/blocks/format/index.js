...
const Preformatted = (0, component_1.default)(() => Promise.resolve().then(() => require('./preformatted')));
const Pullquote = (0, component_1.default)(() => Promise.resolve().then(() => require('./pullquote')));
exports.default = {
    Code,
    Html,
    Preformatted,
