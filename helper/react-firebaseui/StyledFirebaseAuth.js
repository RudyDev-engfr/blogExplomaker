module.exports = (function (i) {
  ...
  return (
    ...
    (o.c = e),
    (o.d = function (i, e, t) {
      o.o(i, e) || Object.defineProperty(i, e, { enumerable: !0, get: t })
    }),
    (o.r = function (i) {
  ...
  function (i, e, o) {
    ...
    var t,
      a = o(1),
      r = (t = a) && t.__esModule ? t : { default: t }
    var n = Promise.resolve(),
      l = (function (i) {
        function e(o) {
          ...
          return (
            (t.uiConfig = o.uiConfig),
            (t.firebaseAuth = o.firebaseAuth),
            (t.className = o.className),
            (t.uiCallback = o.uiCallback),
            (t.unregisterAuthObserver = function () {}),
            t
          )
        }
        return (
          ...
          (e.prototype.componentDidMount = function () {
            ...
            return n.then(function () {
              ;(i.firebaseUiWidget =
                e.auth.AuthUI.getInstance() || new e.auth.AuthUI(i.firebaseAuth)),
                'popup' === i.uiConfig.signInFlow && i.firebaseUiWidget.reset(),
                (i.userSignedIn = !1),
                (i.unregisterAuthObserver = i.firebaseAuth.onAuthStateChanged(function (e) {
                  !e && i.userSignedIn && i.firebaseUiWidget.reset(), (i.userSignedIn = !!e)
                })),
                i.uiCallback && i.uiCallback(i.firebaseUiWidget),
                i.firebaseUiWidget.start('#firebaseui_container', i.uiConfig)
            })
          }),
      ...
      return (
        ...
        (e.i = function (i, o) {
          ...
          for (a = 0; a < i.length; a++) {
            var n = i[a]
            ;('number' == typeof n[0] && t[n[0]]) ||
              (o && !n[2] ? (n[2] = o) : o && (n[2] = '(' + n[2] + ') and (' + o + ')'), e.push(n))
          }
        }),
        e
      )
  ...
  function (i, e, o) {
    ...
    function u(i, e) {
      for (var o = 0; o < i.length; o++) {
        ...
        if (a) {
          a.refs++
          for (var n = 0; n < a.parts.length; n++) a.parts[n](t.parts[n])
          for (; n < t.parts.length; n++) a.parts.push(k(t.parts[n], e))
        } else {
          var l = []
          for (n = 0; n < t.parts.length; n++) l.push(k(t.parts[n], e))
          r[t.id] = { id: t.id, refs: 1, parts: l }
        }
      }
    }
    function g(i, e) {
      for (var o = [], t = {}, a = 0; a < i.length; a++) {
        ...
        t[n] ? t[n].parts.push(l) : o.push((t[n] = { id: n, parts: [l] }))
      }
      return o
    }
    function c(i, e) {
      var o = s(i.insertInto)
      if (!o)
        throw new Error(
      ...
      if ('top' === i.insertAt)
        t
          ...
          b.push(e)
      else if ('bottom' === i.insertAt) o.appendChild(e)
      else {
        if ('object' != typeof i.insertAt || !i.insertAt.before)
          throw new Error(
            "[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (https://github.com/webpack-contrib/style-loader#insertat)\n"
          )
        var a = s(i.insertInto + ' ' + i.insertAt.before)
        o.insertBefore(e, a)
      }
    }
    function x(i) {
    ...
    function m(i) {
      ...
      return void 0 === i.attrs.type && (i.attrs.type = 'text/css'), h(e, i.attrs), c(i, e), e
    }
    function h(i, e) {
    ...
    function k(i, e) {
      ...
      if (e.singleton) {
        var n = p++
        ;(o = d || (d = m(e))), (t = y.bind(null, o, n, !1)), (a = y.bind(null, o, n, !0))
      } else
        i.sourceMap &&
        'function' == typeof URL &&
        ...
        'function' == typeof btoa
          ? ((o = (function (i) {
            ...
            (t = I.bind(null, o, e)),
            (a = function () {
              x(o), o.href && URL.revokeObjectURL(o.href)
            }))
          : ((o = m(e)),
            (t = v.bind(null, o)),
            (a = function () {
    ...
    var _,
      w =
        ((_ = []),
        function (i, e) {
          return (_[i] = e), _.filter(Boolean).join('\n')
        })
    function y(i, e, o, t) {
      var a = o ? '' : t.css
      if (i.styleSheet) i.styleSheet.cssText = w(e, a)
      else {
    ...
    function v(i, e) {
      var o = e.css,
        t = e.media
      if ((t && i.setAttribute('media', t), i.styleSheet)) i.styleSheet.cssText = o
      else {
    ...
    function I(i, e, o) {
      ...
      ;(e.convertToAbsoluteUrls || r) && (t = f(t)),
        a &&
          (t +=
