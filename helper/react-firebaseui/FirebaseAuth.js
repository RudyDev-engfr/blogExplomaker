...
// eslint-disable-next-line prefer-const, no-use-before-define
...
let ELEMENT_ID = 'firebaseui_container'

let firebaseUiDeletion = Promise.resolve()

let FirebaseAuth = (function (_React$Component) {
  ...
  FirebaseAuth.prototype.componentDidMount = function componentDidMount() {
    ...
    return firebaseUiDeletion.then(function () {
      _this2.firebaseUiWidget =
        firebaseui.auth.AuthUI.getInstance() || new firebaseui.auth.AuthUI(_this2.firebaseAuth)
